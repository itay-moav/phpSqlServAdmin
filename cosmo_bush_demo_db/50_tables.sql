CREATE TABLE wormholes.wormhole(
    ...
    CONSTRAINT FK_point_a FOREIGN KEY (point_a)
            REFERENCES stellar_bodies.star_systems(star_system_id),
    CONSTRAINT FK_point_b FOREIGN KEY (point_b)
            REFERENCES stellar_bodies.star_systems(star_system_id)
);

INSERT INTO wormholes.wormhole(wormhole_name,discovered_by,discovered_at,capacity,point_a_to_b_direction,point_a,point_b) VALUES
